...
def construct_optimizer(model, cfg):
    ...
    optim_params_names = [
        {
            "params": [n for n, p in model.named_parameters() if n in decay_parameters and p.requires_grad],
            "weight_decay": cfg.solver.weight_decay,
        },
        {
            "params": [n for n, p in model.named_parameters() if n not in decay_parameters and p.requires_grad],
            "weight_decay": 0.0,
        }
    ]
    #
