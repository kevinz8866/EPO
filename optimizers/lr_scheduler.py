...
def lr_factory(model, cfg, steps_in_epoch):
    ...
    if lr_policy == "cosine":
        ...
        scheduler = WarmupCosineSchedule(
            ...
            t_total=total_steps,
            lower_bound = cfg.solver.lower_bound
        )
...
class WarmupLinearSchedule(LambdaLR):
    ...
    def __init__(self, optimizer, warmup_steps, t_total, last_epoch=-1, lower_bound=0.0):
...
class WarmupCosineSchedule(LambdaLR):
    ...
    def __init__(self, optimizer, warmup_steps, t_total, cycles=0.5, last_epoch=-1, lower_bound=0.0):
        self.warmup_steps = warmup_steps
        self.t_total = t_total
        self.cycles = cycles
        self.lower_bound = lower_bound
    ...
    def lr_lambda(self, step):
        ...
        return max(
            self.lower_bound, 0.5 * (1.0 + math.cos(math.pi *
